...
本目录包含全国城市地铁客流数据可视化大屏项目的全部技术文档。请按需查阅。

| 文档 | 说明 |
|------|------|
| [PROJECT_OVERVIEW.md](PROJECT_OVERVIEW.md) | 项目目标、覆盖范围、已完成能力与能力边界总览 |
| [ARCHITECTURE_DATA_FLOW.md](ARCHITECTURE_DATA_FLOW.md) | 数据管道架构与各阶段数据流详解 |
